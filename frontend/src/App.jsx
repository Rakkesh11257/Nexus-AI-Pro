  ...
  return (
    <div style={S.page}>
      ...
      <form onSubmit={handleSubmit} style={S.card}>
        ...
        {mode === 'signup' && <div style={{ display: 'flex', alignItems: 'flex-start', gap: 8, marginTop: 8 }}><input type="checkbox" checked={agreeTerms} onChange={e => setAgreeTerms(e.target.checked)} style={{ marginTop: 3, accentColor: '#667eea', width: 16, height: 16, flexShrink: 0, cursor: 'pointer' }} /><span style={{ fontSize: 12, color: '#888', lineHeight: 1.5 }}>I agree to the <a href="https://nexusaipro.com/terms.html" target="_blank" rel="noopener noreferrer" style={{ color: '#667eea' }}>Terms & Conditions</a>. I am 18+ and accept full responsibility for all content I generate.</span></div>}
